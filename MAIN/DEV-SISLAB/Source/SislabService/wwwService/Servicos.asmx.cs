...
namespace Embratel.Sislab.Servico
{
    ...
    public class Usuarios : System.Web.Services.WebService
    {
        ...
        public string ObtemUsuarioTeste()
        {
            ...
            try
            {
                ret = ad.ObtemUsuarioTeste();
            }
            catch (Exception ex)
            {
                ret = "ERRO[ObtemUsuarioTeste]: " + ex.Message;
            }
            return ret;
        }
        ...
        public string ObtemTodosOsDadosUsuario(string login, string dominio)
        {
            ...
            try
            {
                ret = ad.ObtemTodosOsDadosUsuario(login, dominio);
            }
            catch (Exception ex)
            {
                ret = "ERRO[ObtemTodosOsDadosUsuario]: " + ex.Message;
            }
            return ret;
        }
