...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/sislabsvc/servicos.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">Usuarios</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="servicos.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="servicos.asmx?op=DownloadArquivo">DownloadArquivo</a>
              ...
              <li>
                <a href="servicos.asmx?op=EnviaEmail">EnviaEmail</a>
              ...
              <li>
                <a href="servicos.asmx?op=EnviaEmailGenerico">EnviaEmailGenerico</a>
              ...
              <li>
                <a href="servicos.asmx?op=ObtemTodosOsDadosUsuario">ObtemTodosOsDadosUsuario</a>
              ...
              <li>
                <a href="servicos.asmx?op=ObtemUsuario">ObtemUsuario</a>
              ...
              <li>
                <a href="servicos.asmx?op=ObtemUsuarioTeste">ObtemUsuarioTeste</a>
              ...
              <li>
                <a href="servicos.asmx?op=UploadArquivo">UploadArquivo</a>
