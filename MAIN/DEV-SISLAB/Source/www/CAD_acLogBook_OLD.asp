...
<tr>
	<td><b>Descrição:&nbsp;</b></td>
	<td><input type="text" class="texto1" name="descricao" size=85 maxlength="255" value="<%=desc%>"></td>
</tr>
<tr>
...
If Not (objRS.Eof And objRS.Bof) Then
	...
	While Not objRS.Eof
		...
		If (oc <> "") And (Not Env.UsuarioCRT) Then
			chr_Buf = chr_Buf & "		x"
		Else
			chr_Buf = chr_Buf & "		<a href='#' onclick='javascript:Excluir(" & objRS("ACA_ID") & ", """ & objRS("ACA_LINK") & """);'>Excluir</a>"
		End If
