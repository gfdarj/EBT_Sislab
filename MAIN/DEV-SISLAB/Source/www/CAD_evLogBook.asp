...
call ImprimeCabecalho2(TITULO_SITE, MENU_ON, true, "", "Cadastro de eventos - Log Book", "location.href='sel_cad_logbook.asp'", "")
...
<tr valign="middle"> 
	<td colspan="10" class="nome_cp">
		...
		<br>
		<font color=#FF0000>&nbsp;&nbsp;</font><b>Colaboradoes Associados / Ocorrência:&nbsp;<br>
...
<tr valign="middle"> 
	<td colspan="10" >
		&nbsp;&nbsp;<font color=#FF0000>*</font>&nbsp;<b>RAT:</b>
		<%
		'>> Nova ocorrencia
...
<tr valign="middle"> 
	<td colspan="10">
		&nbsp;&nbsp;<b>Requisito da Norma ou Documento Associado :<br></b>
		&nbsp;&nbsp;<textarea class="texto1" name="norma" cols="140" rows="4"></textarea>
	</td></tr>
<tr valign="middle"> 
	<td colspan="10">
		&nbsp;&nbsp;<b>observações :<br></b>
...
<tr valign="middle"> 
	...
	<td colspan="5" align="right">
		<%if ehRat then%>
			<input type="button" class="fontmenu1" name="btAcao" value="Tomar Nova A��o" onClick="NovaAcao()">
		<%end if%>
		&nbsp;&nbsp;
	</td>
</tr>
<tr>
	<td colspan="10">
		<table width="100%" class="tabela1" cellpadding="0" cellspacing="0">
		<tr>
			<td width="10px">&nbsp;</td>
			<td>
				<div style="width: 100%; height:90px; border: solid thin silver; marginheight:0; marginwidth:0;">
...
<tr valign="middle" height=45>
		<td colspan="10">
			...
			<%if ocorrencia = "" and not ehRat then%>
				<input class="texto1" type="button" onClick="ValidaCampos()" name="bt" value="&nbsp;Cadastra&nbsp;" />
			<%elseif ocorrencia <> "" and not ehRat then%>
				<input class="texto1" type="button" onClick="volta()" name="bt" value="&nbsp;&nbsp;&nbsp;&nbsp;Ok&nbsp;&nbsp;&nbsp;&nbsp;" />
			<%elseif ehRat then%>
				<input class="texto1" type="button" onClick="document.forms[0].concluidoGQ.value='1';ValidaCampos()" name="bt" value="Salvar Ocorr�ncia" />
			<%end if%>
		</td>
	</tr>
</table>
