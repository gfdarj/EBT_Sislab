...
<BR/><center><H1>TRANSPORTES DO CRT</H1></center>
...
While Not RS.Eof
	...
	If bln_EhRat And bln_Alteracao And (Not bln_Imprime) Then
		chr_Buf =  chr_Buf & _
				"		<input name='ida" & RS(0) & "' type='text' class='texto1' size='6' maxlength='5' value='" & Left(rs(1), 5) & "'>"
	Else
	...
	If bln_EhRat And bln_Alteracao And (Not bln_Imprime) Then
		chr_Buf =  chr_Buf & _
				"		<input name='volta" & RS(0) & "' type='text' class='texto1' size='6' maxlength='5'  value='" & Left(rs(2), 5) & "'>"
	Else
	...
	If bln_EhRat And bln_Alteracao And (Not bln_Imprime) Then
		chr_Buf =  chr_Buf & _
				"	<td align='center'>" & _
				"		<input name='btn_altera" & RS(0) & "' type='button' class='texto1' value='Alterar' onclick='javascript:altera(" & RS(0) & ");'>" & _
				"		&nbsp;" & _
				"		<input name='btn_apaga" & RS(0) & "' type='button' class='texto1' value='Excluir' onclick='javascript:apaga(" & RS(0) & ");'>" & _
				"	</td>"
	End If
