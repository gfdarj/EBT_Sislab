...
<tr valign="top">
	<td width="150"><font class="Fonttit3Cad"><b>Outras Caracter&iacute;sticas:</b></font><br><select multiple name="carac_outras" style="width: 150px;" ondblclick="javascript:adiciona(document.formulario.carac_outras, vcarac_outras, document.formulario.carac_comp, vcarac_comp);" size="10" ></select></td>
	...
	<td width="230"><font class="Fonttit3Cad"><b>Caracter&iacute;stica do componente (Qtde):</b></font><br><select multiple name="carac_comp" style="width: 150px;" ondblclick="javascript:adiciona(document.formulario.carac_comp, vcarac_comp, document.formulario.carac_outras, vcarac_outras);" size="10" ></select></td>
