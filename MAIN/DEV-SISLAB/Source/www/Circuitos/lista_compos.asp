...
strSQL = "select cpt_id, cpt_nome, tpc_nome from fac_componentes inner join fac_tipo_componente on fac_componentes.tpc_id = fac_tipo_componente.tpc_id order by tpc_nome"
call Env.RecordSet( true, objRS, strSQL)
if( objRS.BOF and objRS.EOF ) then
	response.redirect( "index.asp" )
end if %>
<br>
<table width="500px" class="tipo1" align="center">
	...
	<tr>
		<td class="titulo" colspan="2">Componentes Cadastrados</td>
	</tr>
	<tr>
		<th>Componente</th>
...
do while( not objRS.EOF ) %>
	...
	<tr>
		<td>&nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:self.location.href='componentes.asp?cpt_id=<%= objRS( "cpt_id" ) %>'"><%= objRS( "cpt_nome" ) %></a></td>
		<td>&nbsp;&nbsp;&nbsp;<%= objRS( "tpc_nome" ) %></td>
	</tr><%
	objRS.MoveNext
loop %>
</table><%
