...
function Valida()	{
	...
	if (f.novofabricante.value == "")
		alert( "Fabricante do componente inválido" );
	else	{
		f.target = "escondido";
		f.method = "post";
		f.action = "ins_novofabricante.asp"
		f.submit();
	}
}
</script>
...
<body bgcolor="#FFFFFF" topmargin=0 leftmargin=0 scroll="yes">
<form name="formulario" method="post">
<input type="hidden" name="familia" value="<%=Request.querystring("familia")%>">
<table width="100%" height="100%" class="trcadtit1" border="1" align="center" cellpadding="6" align="center">
<tr><td>
	<table width="100%" height="100%">
	<tr> 
		<td><font class="Fonttit3Cad"><b>Nome Fabricante:</b></font></td>
		<td><input type="text" value="" name="novofabricante" size="40" maxlength="200" class="textbox"></td>
	</tr>
	</tr>
	<tr>
