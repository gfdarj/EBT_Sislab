...
If Not (objRS.Eof And objRS.Bof) Then '-- ITEM VALIDO --
	...
	reservado = VerificaReservaItem(true, Conn, request("ag_numero"), objRS("EQ_ID"), false)%>
...
<%	Call MarcaItemReservado((reservado <> ""), request("linhaTabela"))
...
<%	Call MarcaItemReservado(false, request("linhaTabela"))
end if
