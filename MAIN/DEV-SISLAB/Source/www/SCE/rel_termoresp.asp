...
<%
call ImprimeCabecalho ("", MENU_ON, true, "Termo de Responsabilidade", "", "history.go(-1);")
%>
...
<%		rec.movenext
	...
	<td>
		T&iacute;tulo:&nbsp;
		<input class="form" type="Text" name="titulo" size="70" value="<b><u>Termo de Responsabilidade</u></b>">
	</td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr>
...
<tr>
	<td colspan="2">
	<input class="form" type="submit" value=" Gerar Termo de Responsabilidade ">
	</td>
</table>
</form>
<%
