  		...
  		<table width="100%" cellpadding=0 cellspacing=0>
    		  <tr>
				<td>
					<TABLE WIDTH="600">
							<TR>
								...
								<input type="text"  name="doc_responsavel" size="30" maxlength="50" value="<%=rec("doc_responsavel")%>"></td>
								<TD >Data de Emissão:&nbsp;
				...
				<td>
					<TABLE WIDTH="600">
							<TR>
								...
								<input type="text"  name="doc_numero" size="10" maxlength="50" value="<%=Zeros(rec("doc_id"),4)%>" disabled></td>
								<TD >Nome do Cliente:&nbsp;
								<input type="text"  name="doc_nome" size="50" maxlength="50" value="<%=rec("doc_nome")%>"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<td>
					<TABLE WIDTH="600">
							<TR>
								...
								<input type="text"  name="doc_fone" size="30" maxlength="50" value="<%=rec("doc_fone")%>"></td>
								<TD >Email do Cliente:&nbsp;
								<input type="text"  name="doc_mail" size="30" maxlength="50" value="<%=rec("doc_mail")%>"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<td>
					<TABLE WIDTH="600">
							<TR>
								...
								<input type="text"  name="doc_ide" size="30" maxlength="50" value="<%=rec("doc_ide")%>"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<td>
					<TABLE WIDTH="600">
							<TR>
								<TD  colspan=2>Empresa do Cliente:&nbsp;
<%			if IsNull(rec("enf_id")) then valor = "" else valor = cstr(rec("enf_id"))
			RW Combo.Fornecedor("enf_id", valor, "N", "FORNECEDOR", true)%>
								<br>OU PREENCHA:
								<input type="text"  name="doc_empresa" size="50" maxlength="50" value="<%=rec("doc_empresa")%>"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr> 
	      			<td><br><input type="submit" name="Submit" value=" Alterar " >&nbsp;&nbsp;
