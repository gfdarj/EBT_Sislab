...
'''''		If int_Erro <> 0 Then
'''''			RW "<tr><td><font color='red'><B>Arquivo " & RS("arq_nomearq") & " n„o alterado !!!</B></font><BR><BR></td></tr>"
'''''		Else
'''''			'RW "<tr><td>UPDATE Arquivos SET arq_nomearq='" & chr_Arquivo & "'  WHERE arq_codarq = " & RS("arq_codarq") & "</td></tr>"
...
%>
<tr>
	<td>CÛdigo Interno: <%=RS("arq_codarq")%><BR><BR>
...
Function ValidaNomeArquivo(ByRef chr_arquivo, bln_TrocaNome)
	...
	ComAcentos = "!@#$%®&*()-?:{}][ƒ≈¡¬¿√‰·‚‡„… À»ÈÍÎËÕŒœÃÌÓÔÏ÷”‘“’ˆÛÙÚı‹⁄€¸˙˚˘«Á "
