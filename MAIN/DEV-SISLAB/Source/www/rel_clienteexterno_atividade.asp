...
if request("index") = "1" then
	Call Tela.ImprimeCabecalho2("", MENU_OFF, false, "100%", "Relatório de Clientes Externos por Atividade", "SO_IMPRESSORA", "")
else
	Call Tela.ImprimeCabecalho2(TITULO_SITE, MENU_ON, true, "", "Relatório de Clientes Externos por Atividade", "", "")
end if
%>
