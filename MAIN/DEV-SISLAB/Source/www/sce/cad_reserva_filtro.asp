...
<tr>
	<td align="center">
		<input type="button" class="btn btn-primary" value=" Incluir "  onClick="javascript:IncluiListaItens();">
		&nbsp;&nbsp;&nbsp;
		<input type="button" class="btn btn-primary" value=" Voltar "  onClick="javascript:window.close();">
	</td>
</tr>
</table>
