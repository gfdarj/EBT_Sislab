...
<%
Dim objSiteRS, cont, sSQL, Upload
...
For cont = 1 To Arquivo.TotalArquivos
	...
	'sSQL = "Select Arq_CodArq from arquivos where ARQ_NOMEARQ='" & Arquivo.ArquivoSubPasta(cont) &"'; "
	'RW sSQL & "<BR>"
	'RE
	'Call Env.RecordSet(True, objSiteRS, sSQL)
...
<tr>
	<td>
		&nbsp;<span class="vermelho2">&raquo;</span>&nbsp;<span class="texto1b" style="font-size: 12px;">Arquivos Gravados</span>
	</td>
</tr>
<tr>
	<td>
