...
Dim bln_AchouEBT, Ebt, int_sigilo
Dim chr_Username, chr_Orgao, chr_NomeResponsavel, chr_Matricula, chr_Ramal
...
If num_ag <> "" Then
	...
	If not (objSiteRS.Eof And objSiteRS.Bof) then
		...
		chr_Orgao = objSiteRS("AG_ORGAO")
		chr_NomeResponsavel = objSiteRS("AG_NOMERESP")
		chr_Matricula = objSiteRS("AG_MATRICOLARESP")
		chr_Ramal = objSiteRS("AG_TELEFONERESP")
		chr_Username = objSiteRS("AG_USERNAME")
		If InStr(1, objSiteRS("AG_USERNAME"), "@") = 0 Then
            chr_Username = chr_Username & "@embratel.com.br"
        End If
    End If
End If

'--------------------------------------------------------------------------------------
' Se for o RAT e fez a busca pelo solicitante, busco os dados da Embratel
'--------------------------------------------------------------------------------------
If Env.ehRAT Then 
	...
	If solicitante <> "" then
		...
		If Ebt.ehFuncionario Then 
            chr_Orgao = Ebt.Sigla_Orgao()
            chr_NomeResponsavel = Ebt.Nome_Reduzido
            chr_Matricula = Ebt.Matricula
            chr_Ramal = Ebt.TEL1_COM
            chr_Username = solicitante & "@embratel.com.br"
		End If
	End If
End If
...
%>
    ...
    <tr height="34"> 
	    <td colspan="4">
            &nbsp;&nbsp;<span class="vermelho2"><b>*</b></span>&nbsp;Nome do Responsável: &nbsp;
    ...
    <tr height="34">
	    ...
	    <td  colspan="2">&nbsp;&nbsp;<span class="vermelho2"><b>*</b></span>&nbsp;E-mail/Usuário:&nbsp;
		    <input class="texto1" name="txtUsername" size="30" tabindex="5" maxlength="70">
	    </td>
