...
'-- Status de equipamentos e acessуrios
Const STATUS_CADASTRADO = 0
Const STATUS_EM_USO = 2
Const STATUS_EM_ESTOQUE = 1
Const STATUS_EXPEDIDO = 3
Const STATUS_EXPEDIDO_SUBST = 4		'Expedido com substituiзгo

'-- Tipos de Movimentaзгo
Const MOV_ENTRADA = 1
...
'-- Propriedade dos equipamentos (nгo consumнveis)
...
Const PERFIL_LOG = 2	'-- Perfil de usuбrio da logistica
Const PERFIL_RAT = 3	'-- Perfil de usuбrio SISLAB - RAT ou RT

Const EQSETUP_AMOSTRA = "A"			'-- Equipamento й tido como Amostra
Const EQSETUP_EQUIPAMENTO = "E"		'-- Equipamento

Const NF_ENTRADA = 1	'-- Nota fiscal de entrada
Const NF_SAIDA = 2		'-- Nota fiscal de saнda
