...
if ag <> "null" then	'-- edicao do agendamento
	...
	call enviaEmailsAS(Env.oConn, objrs(0), "SISLAB - AS " & objrs(0) & " " & objrs1("S_DESCRICAO"), replace(objrs1("S_MENSAGEM"), "pesqscr.asp", "pesqscr.asp?num_ag=" & objrs(0)) & "<BR><BR>")

	'call Enviar_Email("gilbertof@yahoo.com", "gilbertof@yahoo.com", "SISLAB - AS " & objrs(0) & " " & objrs1("S_DESCRICAO"), replace(objrs1("S_MENSAGEM"), "pesqscr.asp", "pesqscr.asp?num_ag=" & objrs(0)))
