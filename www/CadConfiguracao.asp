...
<tr>
	<td width="100px">&nbsp;<span class="vermelho2"><b>*</span>&nbsp;Código:</b></td>
...
<tr>
	<td width="100px">&nbsp;<span class="vermelho2"><b>*</span>&nbsp;Valor :</b></td>
	<td><input type="Text" name="valor1" size="30" class="texto1"></td>
<tr>

<tr>
	<td width="100px">&nbsp;<span class="vermelho2"><b>*</span>&nbsp;Tipo do Valor :</b></td>
	<td><input type="Text" name="tipovalor1" size="30" class="texto1"></td>
<tr>

<tr>
	<td width="100px">&nbsp;<span class="vermelho2"><b>*</span>&nbsp;Inativo :</b></td>
