...
<title>Pesquisa de Satisfação - CRT</title>
...
<%
sSQL="Select * from PesquisaSatisfacao "
sSQL=sSQL&" where PSQ_nag="&parnag
sSQL=sSQL&" order by psq_id asc;"
