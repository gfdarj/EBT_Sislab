...
'response.write item & "<BR>"
	...
	Set RS = Conn.Execute("SELECT COUNT(*) AS Total FROM SCE_Reserva_Equipamentos WHERE AG_NUMERO = " & ag_numero & " AND EQ_ID = " & lista_itens(0))
	If Not RS.Eof Then
...
If Len(lista_eqid) > 0 Then
	...
	Call Conn.Execute("DELETE FROM SCE_Reserva_Equipamentos WHERE AG_NUMERO = " & ag_numero & " AND EQ_ID NOT IN (" & lista_eqid & ")")
End If
