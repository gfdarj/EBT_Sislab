...
<%
call ImprimeCabecalho ("", MENU_ON, true, "Relatório de Equipamentos", "", "history.go(-1);")
%>
...
<tr>
	<td colspan="2">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
	Registro/Certificado/CDE/RMA:&nbsp;<input type="text" class="form" name="cde_equip" size="10">
	</td>
</tr>
