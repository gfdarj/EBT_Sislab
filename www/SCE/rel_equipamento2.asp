...
dim ssql, where, dt_ini, dt_fim, rec, recInst
...
call ImprimeCabecalho ("", MENU_ON, true, "Relatório de Equipamentos e Instrumentais", "", "history.go(-1);")
%>
...
<tr>
	<td>&nbsp;</td>
	<td>
		<table class="texto" cellpadding="2" cellspacing="0" border="1">
<%			controle = ""
			nomecontrole = ""
...
<tr>
	<td>&nbsp;</td>
	<td>
		<table class="texto" cellpadding="2" cellspacing="0" border="1" width="550px">
		<tr>
...
%>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2" align="right">Total de itens encontrados: <%=rec.recordcount%></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<%
else
%>
