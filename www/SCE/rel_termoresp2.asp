...
call ImprimeCabecalho ("", MENU_OFF, false, "", "", "history.go(-1);")
...
<tr><td colspan="2" class="titulo" bgcolor="#c0c0c0">DADOS DO CLIENTE - RESPONS&Aacute;VEL</td></tr>
...
%>		<table width="100%" cellpadding="2" cellspacing="0" class="texto" border="1">
		...
		<tr>
			<th align="left" width="120px">Endere&ccedil;o:</th>
			<td><%
...
%>				&nbsp;
		...
		<tr><th align="left" width="120px">Resp. T&eacute;cnico:</th><td><%=rec("DOC_RESPONSAVEL")%>&nbsp;</td></tr>
		</tr>
		</table><%
end if
rec.close
...
<tr><td class="titulo">De ac&ocirc;rdo: _________________________________________________</td></tr>
...
<tr>
	<td>
		...
		<tr><td width="145px">Agente de Log&iacute;stica:</td><td width="*">_________________________________________________</td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td width="145px">Respons&aacute;vel T&eacute;cnico:</td><td width="*">_________________________________________________</td></tr>
		</table>
	</td>
</tr>
